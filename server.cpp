...
#include "server.h"
        ...
        {
        loc_getretcode=server_working_basic_string1("login","700");
        }
        else{
        loc_getretcode=server_working_basic_string1("login","900");
        }
        ...
        loc_getretcode=server_working_basic_string1("register","700");
        }
        else{
        loc_getretcode=server_working_basic_string1("register","900");
        }
        write(p_disp_detp,loc_getretcode.c_str(),strlen(loc_getretcode.c_str())+1);
        }
        ...
        {
        perror("Unable to find the socket details");
        exit(1);
        }
        ...
        ser onlineUser(sockfd,user,ipaddress,stoi(loc_portsd));
